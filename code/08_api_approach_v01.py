...
BASE_CSV_FILE = 'subsets/subset_3.csv' 
# Ausgabedatei für die Ergebnisse
OUTPUT_CSV_FILE = 'annotations/subset_3_gemini_2.5_pro_annotated.csv'
...
if __name__ == "__main__":
    ...
    # Neue Spalten für die Annotationsergebnisse initialisieren
    annotation_cols = ['alc', 'product', 'warning', 'discount', 'gemini_error']
